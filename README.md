<p align="center">
  <img src="header.svg?v=2" alt="Real-Fruit-Snacks" width="800"/>
</p>
...
| Tool | What It Does | Language |
|------|-------------|----------|
| [**Deluge**](https://github.com/Real-Fruit-Snacks/Deluge) | Nmap & RustScan output parser with color-coded reports and multi-format export | Python |
